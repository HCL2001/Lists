...
public class MyList <E>{
        ...
        public MyList(int initialCapacity) {// Specify the size of the initial capacity
            if (initialCapacity> 0) {//The initial capacity is greater than 0, then allocate an array cache object of the corresponding size
                this.elementData = new Object[initialCapacity];
            } else if (initialCapacity == 0) {//The initial capacity is 0, create a shared empty array instance.
                this.elementData = EMPTY_ELEMENTDATA;
            } else  {//Negative number, throw an exception of illegal parameter
